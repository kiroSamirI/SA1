      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-left top-menu">
                    <li><a class="logout" href="login.html">تسجيل خروج</a></li>
            	</ul>
            </div>
            <div class="top-menu">
            	<ul class="nav pull-left top-menu">
                    <li><a class="logout" href="profile/{{auth()->user()->id}}/edit">تعديل الاعدادت الشخصيه</a></li>
                </ul>
            </div>
        </header>
      <!--header end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="/list_CVs">list CVs</a></li>
                      </ul>
                  </li>
                  <li class="mt">
