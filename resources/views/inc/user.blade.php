              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu"> 
                      <a href="javascript:;" >
                          ...
                          <span>امتحان  تجريبى</span>
                      </a>
                      <ul class="sub">
                            @foreach(auth()->user()->subject_user as $subject)
                            <li><a  href="/list_trial_test/{{$subject->id}}"> {{$subject->name}}-{{$subject->year}}-{{$subject->stage}} </a></li>
                            @endforeach
                  ...
                  <li class="sub-menu"> 
                    ...
                    <ul class="sub">
                          @foreach(auth()->user()->subject_user as $subject)
                          <li><a  href="/see_exam/{{$subject->id}}"> {{$subject->name}}-{{$subject->year}}-{{$subject->stage}} </a></li>
                          @endforeach
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                            @foreach(auth()->user()->subject_user as $subject)
                            <li><a  href="/homework/{{$subject->id}}"> {{$subject->name}}-{{$subject->year}}-{{$subject->stage}} </a></li>
                            @endforeach
                      </ul>
                  </li>
